...
export function generateCustomCommandAction(instance) {
	...
	const STANDARD_RESPONSE = [
		{ bytes: '90 40 FF', mask: 'FF F0 FF', params: '' },
		{ bytes: '90 50 FF', mask: 'FF F0 FF', params: '' },
	]
	...
	return {
		...
		options: [
			...
			...generateInputsForCommandParameters(),
			{
				...
				id: 'response_count',
				default: STANDARD_RESPONSE.length,
				min: 1,
				max: MAX_MESSAGES_IN_RESPONSE,
			},
			...(() => {
				function getDefault(i, field) {
